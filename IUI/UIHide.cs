...
namespace ClassLibrary1
{
    ...
    public class UIHide
    {
        ...
        public UIHide(Form frm, Timer timer)
        {
            this.frm1 = frm;
            this.timer1 = timer;
        ...
        {
            if (this.frm1.WindowState == FormWindowState.Minimized)
            {  //最小化时所需的操作 
                //MessageBox.Show("min");
                this.frm1.WindowState = FormWindowState.Normal;
                this.frm1.Hide();
            }
            else
            {
            ...
            //if (this.frm1.WindowState == FormWindowState.Maximized)
            //{  //最大化时所需的操作  
                //MessageBox.Show("max"); 
           // }
        }
